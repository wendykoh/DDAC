<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create Schedule.aspx.cs" Inherits="DDAC.Create_Schedule" %>
         ...
         <div class="w3-container w3-centered w3-border-purple w3-content" style="max-width:95%">
            ...
            <table style="margin-left:15px">
                ...
                <tr>
                    ...
                    <td class="auto-style3"> <asp:TextBox ID="ddate" name="ddate" type="date" class="auto-style2" required="required" runat="server" CssClass="auto-style9"/></td>
                </tr>
                <tr>
                    <td class="auto-style1"><asp:Label ID="Label5" runat="server" Text="Arrival Date" style="float:left"></asp:Label></td>
                    <td class="auto-style3"><asp:TextBox ID="adate" runat="server" name="adate" type="date" class="auto-style2" required="required" CssClass="auto-style9"></asp:TextBox> </td> 
                </tr>
                <tr>
                    <td class="auto-style1"><asp:Label ID="Label6" runat="server" Text="Ship ID" style="float:left"></asp:Label></td>
                    <td class="auto-style3">
                       <asp:DropDownList ID="shipid" runat="server" CssClass="auto-style8" DataSourceID="SqlDataSource2" DataTextField="shipid" DataValueField="shipid" Height="24px" Width="206px"></asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ddacdatabaseConnectionString %>" SelectCommand="SELECT [shipid] FROM [Ship] WHERE ([status] = @status)">
                            <SelectParameters>
           ...
           <br/><br/>
            ...
            <asp:Button ID="Submit1" runat="server" Text="Submit" Width="80px" style="margin-left:15px" OnClick="Submit1_Click1" />
            <br/><br/>
        </div>
        </div>
             </div>
