<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check Schedule.aspx.cs" Inherits="DDAC.Check_Schedule" %>
                ...
                <div class="w3-row-padding w3-mobile" style="width:80%">
                    <div class=" w3-quarter">
                        ...
                        <select class="w3-select w3-border" id="searchvia" style="margin-top:7px;margin-bottom:7px" required="required">	      
                            <option value="1">Schedule ID</option>
                    ...
                    <div class="w3-quarter">
                        <label></label><br/><br/>
                        <asp:Button ID="add" Text="Create Schedule" runat="server" style="float:right;margin-right:15px" OnClick="add_Click"/>
                        </div>
                </div>
