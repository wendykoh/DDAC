<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check details.aspx.cs" Inherits="DDAC.Check_details" %>
            ...
            <table style="margin-left:15px">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="auto-style3"><asp:TextBox id="status" name="status" type="text" class="auto-style2" ReadOnly="true" runat="server" CssClass="auto-style11"/></td>
                </tr>
           </table>
           <br/><br/>
           <asp:Button ID="Submit1" runat="server" Text="Cancel" Width="80px" style="margin-left:15px" OnClick="Submit1_Click"/>
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ddacdatabaseConnectionString %>" SelectCommand="SELECT [shippingid], [departureport], [arrivalport], [shippingdate], [weight], [cost], [status], [remarks] FROM [Shipping] WHERE ([shippingid] = @shippingid)">
                         <SelectParameters>
                             <asp:QueryStringParameter Name="shippingid" QueryStringField="sid" Type="String" />
                         </SelectParameters>
                     </asp:SqlDataSource>
            <br/><br/>
        </div>
