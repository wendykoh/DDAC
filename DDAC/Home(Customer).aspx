<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home(Customer).aspx.cs" Inherits="DDAC.Home_Customer_" %>
    ...
    <div class="w3-container w3-centered w3-border-purple w3-content" style="max-width:95%">
            <div class="w3-border" style="margin-top:50px">
                ...
                <div class="w3-row-padding w3-mobile" style="width:80%">
                    ...
                    <div class="w3-quarter">
                        <label></label><br/><br/>
                        <asp:Button ID="add" Text="Add Shipping Request" runat="server" style="float:right;margin-right:15px" OnClick="add_Click"/>
                        </div>
                </div>
